...
public class Framework extends Canvas {
   ...
   /**
    ...
    private void LoadContent()
    {
        try
        {
            dbgLog.log(Level.INFO, "Trying to load menu image...");
            URL menuImgUrl = this.getClass().getResource("/images/menu.jpg");
            menuImg = ImageIO.read(menuImgUrl);
        }
        catch (IOException ex) {
            dbgLog.log(Level.SEVERE, "An error - could not load the image!", ex); // OSB Not even sure what this does.
        }
    ...
    private void GameLoop()
    {
        ...
        // This variables are used for calculating the time that defines for how long
        // we should put threat to sleep to meet the GAME_FPS.
        ...
        while(true)
        {
            ...
            {
                case PLAYING:
                    //dbgLog.log(Level.INFO, "PLAYING"); // Happens too quickly
                ...
                break;
                case GAMEOVER:
                    dbgLog.log(Level.INFO, "GAME OVER");
                    //...
                break;
                case MAIN_MENU:
                ...
                break;
                case STARTING:
                    dbgLog.log(Level.INFO, "STARTING");
                    ...
                    dbgLog.log(Level.INFO, "Going to Main Menu");
                break;
                case VISUALIZING:
    ...
    public void Draw(Graphics2D g2d)
    {
        ...
        {
            case PLAYING:
                game.Draw(g2d, mousePosition()); // Do all the drawing in this function
                //g2d.setColor(Color.white);
                //g2d.drawString("This is some fixed game text.", frameWidth / 2 - 117, frameHeight / 2);

            break;
            case GAMEOVER:
                // Make a snazzy game over graphic
            break;
            case MAIN_MENU:
                g2d.drawImage(menuImg, 0, 0, frameWidth, frameHeight, null);
                g2d.setColor(Color.white);
                g2d.drawString("This is the menu.", frameWidth / 2 - 117, frameHeight / 2);
                g2d.drawString("Press any key to start the game.", frameWidth / 2 - 100, frameHeight / 2 + 30);
                g2d.drawString("SOL", 7, frameHeight - 5);
                break;
            case OPTIONS:
                //...
            break;
