...
public abstract class Canvas extends JPanel implements KeyListener, MouseListener {
    ...
    public abstract void keyReleasedFramework(KeyEvent e); // No idea why keyboard handling is done by Framework
                                                            // while mouse is done by Canvas.
    ...
    @Override
    public abstract void mouseClicked(MouseEvent e); // Why not handle these in Framework too?
